...
df_per=df_per.select(col("state").alias("State"),col("joe_total").alias("Biden Tweets"),"Joe Pos %","Joe Neg %",col("trump_total").alias("Trump Tweets"),"Trump Pos %","Trump Neg %")
df_per.show()
...
df_per= df_per.sort(F.col('State').asc())
print(df_per.show(60,truncate=False))


# COMMAND ----------

# write to pickledf_per.rdd.saveAsPickleFile('post_analysis3to8.pkl')
#df_per=spark.read.parquet("/FileStore/tables/post_analysis3to8/")
#df_per.write.mode('overwrite').parquet("/FileStore/tables/finalcsvresult/")
#df_per=spark.read.parquet("/FileStore/tables/analysis/")
df_per.repartition(1).write.csv(path="/FileStore/finalresultcsv.csv", mode="overwrite", header="true")
#https://community.cloud.databricks.com/files/finalresultcsv.csv/part-00000-tid-257204844832241574-cb94a4b9-c159-4803-b62e-0399e16c0deb-97-1-c000.csv
?o=3628364415716193
#https://community.cloud.databricks.com/files/countposneg.csv/part-00000-tid-3949201546480763775-a20af959-9fa4-42da-a221-ee6b319351b9-4-1-c000.csv?o=3628364415716193
